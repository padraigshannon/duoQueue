...
<body>
    ...
    <div class="arcade-screen px-3 d-flex align-items-center justify-content-center">
            ...
            <div class="col-11 col-md-9 col-lg-7">
                ...
                <div class="neon-box neon-box-lg p-4 text-center">
                    <div class="neon-box neon-box-lg p-4 text-center" style="font-size: clamp(8px, 1vw, 11px);">
                        ...
                        <p>
                            Our goal is to make finding a partner and long term duo easy, fast, and fun.
                        </p>
                        <p class="mb-0">
                            Whether you're grinding ranked or just playing for fun, our goal is to connect players with the perfect partner.
                        </p>
                    </div>
                </div>
